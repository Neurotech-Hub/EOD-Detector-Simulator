...
Context: observed as "strong ringing" in the simulator for C4 < 47 pF, and suspected as a contributor to the continuous-trigger behavior seen in the tank. All sweeps: 300 mV rounded biphasic pulses (200 µs), 0.5 kHz, 4 pulses over 20 ms, stock values unless noted, TI bench.
